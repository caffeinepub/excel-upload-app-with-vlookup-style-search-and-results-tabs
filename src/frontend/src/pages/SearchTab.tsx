...
import { type MatchType, vlookup } from "../lib/vlookup/vlookup";
...
export function SearchTab({ onSearchComplete }: SearchTabProps) {
  ...
  const handleVlookup = async () => {
    ...
    try {
      ...
      alert(
        "An error occurred during VLOOKUP. Please check your inputs and try again.",
      );
    } finally {
      setIsSearching(false);
    }
        ...
        <TabsContent value="vlookup" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Search for multiple values and return matching data from
                selected columns
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="lookup-values">
                  Lookup Values (comma or newline separated)
                </Label>
                <Textarea
                  id="lookup-values"
              ...
              <div className="space-y-2">
                <Label htmlFor="return-columns">
                  Return Columns (select multiple)
                </Label>
                <Select
