...
function AssistantPanel({
  ...
  useFrame((state) => {
    ...
    groupRef.current.position.y =
      Math.sin(state.clock.elapsedTime * 0.5 + 3) * 0.05;
    groupRef.current.rotation.y =
      Math.sin(state.clock.elapsedTime * 0.2 + 1) * 0.03;

    if (glowRef.current) {
      const mat = glowRef.current.material as THREE.MeshStandardMaterial;
      mat.emissiveIntensity =
        0.2 + Math.sin(state.clock.elapsedTime * 2.5) * 0.1;
    }
    if (pulseRef.current) {
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div
                style={{ fontSize: "14px", fontWeight: 800, color: "#a5b4fc" }}
              >
                {pendingTodos}
              </div>
            ...
            >
              <div
                style={{ fontSize: "14px", fontWeight: 800, color: "#c4b5fd" }}
              >
                {remindersCount}
              </div>
            ...
            >
              <div
                style={{ fontSize: "14px", fontWeight: 800, color: "#67e8f9" }}
              >
                {notesCount}
              </div>
