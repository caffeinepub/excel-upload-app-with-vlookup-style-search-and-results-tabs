...
export function AttendanceDateEditor({
  date,
  entry,
  onSave,
  isSaving,
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {!canEditSelectedDate && permissionMessage && (
          <Alert>
        ...
        {isNonWorkingStatus && (
          <Alert>
            <AlertCircle className="h-4 w-4" />
            <AlertDescription>
              This status indicates a non-working day. Working time will be set
              to 0.
            </AlertDescription>
          </Alert>
        )}
        ...
        <Button
          onClick={handleSave}
          disabled={isSaving || !canEditSelectedDate}
          className="w-full"
        >
