  ...
  return (
    <group ref={groupRef} position={[0, -0.8, 0]}>
      ...
      <mesh position={[0, 1.8, 0]} castShadow>
        ...
        <meshStandardMaterial color="#5ab0ff" metalness={0.2} roughness={0.3} />
      </mesh>
      ...
      <mesh position={[-0.15, 0.05, 0]} castShadow>
        ...
        <meshStandardMaterial color="#3a7ecf" metalness={0.3} roughness={0.4} />
      </mesh>
      <mesh position={[0.15, 0.05, 0]} castShadow>
        <capsuleGeometry args={[0.1, 0.6, 8, 16]} />
        <meshStandardMaterial color="#3a7ecf" metalness={0.3} roughness={0.4} />
      ...
      <mesh position={[-0.15, -0.35, 0.1]} castShadow>
        ...
        <meshStandardMaterial color="#2a5e9f" metalness={0.4} roughness={0.3} />
      </mesh>
      <mesh position={[0.15, -0.35, 0.1]} castShadow>
        <boxGeometry args={[0.15, 0.08, 0.25]} />
        <meshStandardMaterial color="#2a5e9f" metalness={0.4} roughness={0.3} />
