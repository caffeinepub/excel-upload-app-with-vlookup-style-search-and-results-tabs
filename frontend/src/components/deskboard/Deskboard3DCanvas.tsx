...
class ThreeErrorBoundary extends Component<{ children: ReactNode; fallback: ReactNode }, { hasError: boolean }> {
  ...
  componentDidCatch(e: Error) { console.warn('3D Deskboard error:', e); }
  render() {
...
function Scene3D({ pendingTodos, remindersCount, notesCount, onSearchOpen }: Deskboard3DCanvasProps) {
  return (
    <>
