import { Home, Upload, Search, FileText, GitCompare, History, Wallet, Bell, Calendar, CheckSquare, FileEdit, UserCheck, Users as UsersIcon, Users, Eye } from 'lucide-react';
...
export function DesktopSidebarNav({ activeTab, onTabChange }: DesktopSidebarNavProps) {
  ...
  const adminItems = isAdmin
    ? [
        ...
        { id: 'observe-users', icon: Eye, label: 'Observe Users' },
      ]
    : [];
